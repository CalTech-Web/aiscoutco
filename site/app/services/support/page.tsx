      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="rounded-2xl border border-slate-700/50 bg-slate-900/50 p-8 mb-12">
            ...
            <p className="text-slate-400 text-sm mb-6">We support AI systems built for service businesses of every kind. The workflows change, but the approach is the same.</p>
