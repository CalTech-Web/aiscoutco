  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        />
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-600/10 rounded-full blur-3xl animate-blob" style={{ willChange: 'transform' }} />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-cyan-600/10 rounded-full blur-3xl animate-blob-alt" style={{ willChange: 'transform' }} />
        <FloatingParticles />
