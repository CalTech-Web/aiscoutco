...
const industries = [
  ...
  },
  {
    ...
    label: "Healthcare",
    description: "Scheduling, patient communication, documentation, and compliance reporting are all candidates for AI automation.",
    link: null,
    cta: null,
  },
  {
    ...
    label: "E-commerce",
    description: "Inventory updates, customer service responses, order tracking, and performance reporting can all be automated with the right AI system.",
    link: null,
    cta: null,
  },
  {
